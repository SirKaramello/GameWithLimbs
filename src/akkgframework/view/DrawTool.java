...
public class DrawTool {
    ...
    public void scale(double x,double y){if(graphics2D!=null) graphics2D.scale(x,y);}
    ...
    public void flipImage(BufferedImage img, double x , double y , double width , double height){
        if(graphics2D!=null) {
            graphics2D.drawImage(img ,(int) (x-width) , (int)(y) ,(int) (width),(int) (height), null);
        }
    }
