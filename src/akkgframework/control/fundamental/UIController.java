...
public class UIController implements ActionListener {
     ...
     */
    public void registerObject(DrawableObject dO){
    ...
    /**
     * Nötig zur Einbindung nativer Java-Fensterelemente
     * @return Liefert das aktuell aktive DrawingPanel-Objekt zurück (als Schnittstelle zu den JFrame-Methoden)
     */
    public DrawingPanel getCurrentDrawingPanel(){
        return this.drawFrame.getActiveDrawingPanel();
    }
